...
namespace app\modules\angularbridge\generators\api;
...
class Generator extends  \app\modules\angularbridge\Generator
{
    ...
    {
        return 'This generator generates an API in Yii2.0  that implement CRUD (Create, Read, Update, Delete)
    ...
    public function getViewPath()
    {
       ...
       // return $module->getViewPath() . '/' . $this->getControllerID() ;
        return $module->getBasePath() . '/angular2/' . $this->getControllerID() ;
    }
