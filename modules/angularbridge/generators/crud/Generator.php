...
namespace app\modules\angularbridge\generators\crud;
...
use app\modules\angularbridge\CodeFile;
...
class Generator extends  \app\modules\angularbridge\Generator
{
    public $modelClass;
    public $moduleID;
    ...
    {
        return 'AngularJs CRUD Generator';
    }
    ...
    {
        return 'This generator generates CRUD in AngularJs with Bootstrap3.0 skin and an API in Yii2.0  that implement CRUD (Create, Read, Update, Delete)
    ...
    public function generateSearchConditions()
    {
        ...
        foreach ($columns as $column => $type) {
            switch ($type) {
                ...
                case Schema::TYPE_DATETIME:
                case Schema::TYPE_TIMESTAMP:
                    $hashConditions[] = "'{$column}' => \$filter['{$column}'],";
                    break;
                default:
                    $likeConditions[] = "->andFilterWhere(['like', '{$column}', \$filter['{$column}']])";
                    break;
            }
        }
