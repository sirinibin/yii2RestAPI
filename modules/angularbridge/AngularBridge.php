...
//namespace yii\gii;
namespace app\modules\angularbridge;
 ...
 * @since 2.0
 */
class AngularBridge extends \yii\base\Module implements BootstrapInterface
{
    /**
     * @inheritdoc
     */
    //public $controllerNamespace = 'yii\gii\controllers';
    public $controllerNamespace = 'app\modules\angularbridge\controllers';
    /**
    ...
    protected function checkAccess()
    {
        ...
        Yii::warning('Access to AngularBridge is denied due to IP address restriction. The requested IP is ' . $ip, __METHOD__);
    ...
    protected function coreGenerators()
    {
        return [
            ...
            */
             //'model' => ['class' => 'yii\gii\generators\model\Generator'],
            'model' => ['class' => 'app\modules\angularbridge\generators\model\Generator'],
            'crud' => ['class' => 'app\modules\angularbridge\generators\crud\Generator'],
            'api' => ['class' => 'app\modules\angularbridge\generators\api\Generator'],
           //'controller' => ['class' => 'app\modules\angularbridge\generators\controller\Generator'],
            //'form' => ['class' => 'app\modules\angularbridge\generators\form\Generator'],
            //'module' => ['class' => 'app\modules\angularbridge\generators\module\Generator'],
           // 'extension' => ['class' => 'app\modules\angularbridge\generators\extension\Generator'],
